...
class Voc:
    def __init__(self, tokenizer=mecab.morphs):
        self.idx2word = []
        self.word2idx = {}
        self.vocab_size = 0
...
def normalizeString(s):
    ...
    s = re.sub(r"""[,:;?!_\-'\"\.(){}\[\]/\\]""", r" ", s)
    s = mecab_tokenizer(s) #토크나이저 변경가능
...
a, b = readVocs('./data/chat.in', 'chat')
...
prepareData('./data/chat.in', 'chat')
c = torch.load('./save/training_data/chat/voc.tar')

#hello = torch.load('./data/chat.in')
