...
tf.app.flags.DEFINE_integer('batchSize', 20, 'batch size') # 배치 크기
tf.app.flags.DEFINE_integer('trainSteps', 10000, 'train steps') # 학습 에포크
tf.app.flags.DEFINE_float('dropoutWidth', 0.8, 'dropout width') # 드롭아웃 크기
...
tf.app.flags.DEFINE_float('teachingForceRate', 0.7, 'teacher forcing rate')
...
tf.app.flags.DEFINE_boolean('tokenizeAsMorph', False, 'set morph tokenize') # 형태소에 따른 토크나이징 사용 유무
