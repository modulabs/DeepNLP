...
><img src="./assets/week01/yandex_embedding_007.png" />
...
><img src="./assets/week01/yandex_embedding_025.png" />
...
><img src="./assets/week01/yandex_embedding_052.png" />

Word2Vec는 [Matrix factorization](http://sanghyukchun.github.io/73/)과 동등하다.

><img src="./assets/week01/yandex_embedding_054.png" />
...
><img src="./assets/week01/yandex_embedding_056.png" />

실제 값과 예측값 사이에 오차 제곱을 하는 것은 LSA와 비슷하다.

><img src="./assets/week01/yandex_embedding_057.png" />

그리고 noise를 제거하기 위한 함수를 추가 했다. 특정 단어가 너무 많이 발생할 경우 이를 최대값 까지만 사용하겠다는 의미 이다.

><img src="./assets/week01/yandex_embedding_058.png" />

# Relations between vectors

Word2Vec에서 백터(king)에서 백터(man)을 빼고 백터(woman)을 더하면 백터(queen)과 비슷한 값이 나온다.

><img src="./assets/week01/yandex_embedding_059.png" />

나라백터 수도백터 관계는 아래와 같다.

><img src="./assets/week01/yandex_embedding_060.png" />

형용사에 대한 비교급/최상위급 관계는 아라와 같다.

><img src="./assets/week01/yandex_embedding_061.png" />

개구리(flog)의 인접 단어들은 아래와 같다.

><img src="./assets/week01/yandex_embedding_062.png" />

Symantic space에서 보면 아래와 같다.

><img src="./assets/week01/yandex_embedding_066.png" />

><img src="./assets/week01/yandex_embedding_067.png" />

><img src="./assets/week01/yandex_embedding_066.png" />

><img src="./assets/week01/yandex_embedding_069.png" />

><img src="./assets/week01/yandex_embedding_070.png" />

><img src="./assets/week01/yandex_embedding_071.png" />

><img src="./assets/week01/yandex_embedding_072.png" />

><img src="./assets/week01/yandex_embedding_073.png" />

><img src="./assets/week01/yandex_embedding_074.png" />

><img src="./assets/week01/yandex_embedding_075.png" />

><img src="./assets/week01/yandex_embedding_076.png" />

Embedding을 평가하는 방법은 아래와 같다. 여러 embedding을 동일한 모델에 적용해 보고 결과가 더 좋을 embedding을 더 좋다고 평가한다.

><img src="./assets/week01/yandex_embedding_077.png" />
...
><img src="./assets/week01/yandex_embedding_079.png" />

기존 embedding을 이용해 새로운 embedding을 만드는 방법은 아래와 같다.

><img src="./assets/week01/yandex_embedding_080.png" />

><img src="./assets/week01/yandex_embedding_081.png" />

><img src="./assets/week01/yandex_embedding_082.png" />

# Skip-gram model to the sentence level

단어가 아닌 문장을 encoding 하는 방법을 사용한다.

><img src="./assets/week01/yandex_embedding_084.png" />

><img src="./assets/week01/yandex_embedding_085.png" />

Machine Translation에서는 아래와 같다.

><img src="./assets/week01/yandex_embedding_087.png" />

Machine Translation에서 번역할 언어의 정보가 없다면 어떻게 할 것인가?

><img src="./assets/week01/yandex_embedding_089.png" />

><img src="./assets/week01/yandex_embedding_090.png" />

결론은 다음곽 같다.

><img src="./assets/week01/yandex_embedding_092.png" />

><img src="./assets/week01/yandex_embedding_093.png" />

><img src="./assets/week01/yandex_embedding_094.png" />
